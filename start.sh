...
python3 main.py --audio "projects/demo/audio/Just takes one try mix even shorter [master]19.06.2025.wav" --debug --width 800 --height 800 $DEBUG_FLAG --monitor "$MONITOR" "$@" 
